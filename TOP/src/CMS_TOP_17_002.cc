...
namespace Rivet
{
  ...
  class Histo1DGroup
  {
    ...
    public:
      Histo1DGroup(CMS_TOP_17_002* an, const vector<string>& hnames, const vector<double>& xbinranges);
  ...
  class CMS_TOP_17_002 : public Analysis
  {
    ...
    CMS_TOP_17_002() : Analysis("CMS_TOP_17_002"), m_thad_decay(3), m_tlep_decay(3), m_tt_jets(4)
    {}
    virtual ~CMS_TOP_17_002()
    {}
  ...
  Histo1DGroup::Histo1DGroup(CMS_TOP_17_002* an, const vector<string>& hnames, const vector<double>& xbinranges) : m_an(an), m_xbins(xbinranges)
  {
  ...
  DECLARE_RIVET_PLUGIN(CMS_TOP_17_002);
