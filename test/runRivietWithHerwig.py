...
process.load('Configuration.Generator.Hadronizer_TuneEE5C_13TeV_powheg_samePDF_herwigpp_cff')
...
process.source = cms.Source("PoolSource",
	...
	'/store/mc/RunIIWinter15wmLHE/TT_13TeV-powheg/LHE/MCRUN2_71_V1-v1/10000/00413642-6BC7-E411-A452-0025904C68DA.root',),
#    'file:LHEfile.root',),
...
process.rivetAnalyzer = cms.EDAnalyzer("RivetAnalyzer",
    ...
    OutputFile = cms.string('Herwig.yoda'),
...
#process.generation_step = cms.Path(process.lheTTdecayFilter*process.generator*process.rivetAnalyzer)
