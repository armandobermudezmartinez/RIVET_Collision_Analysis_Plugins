...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      lep_costheta_CPV_max = binlep_costheta_CPV[6];
    ...
    void analyze(const Event& event) {
      ...
      if (leptonicpartontops.size() == 2 && leptonicpartontops[0].pdgId()*leptonicpartontops[1].pdgId() < 0) {
        ...
        _h_lep_costheta->fill(min(lepPlus_costheta,lep_costheta_max-EPSILON), weight);
        _h_lep_costheta->fill(min(lepMinus_costheta,lep_costheta_max-EPSILON), weight);
        _h_lep_costheta_CPV->fill(min(lepPlus_costheta,lep_costheta_CPV_max-EPSILON), weight);
        _h_lep_costheta_CPV->fill(-min(lepMinus_costheta,lep_costheta_CPV_max-EPSILON), weight);
  ...
  private:
    double dphi_max, dabseta_max, tt_mass_min, tt_mass_max, tt_rapidity_max, tt_pT_max, dabsrapidity_max, lep_costheta_max, lep_costheta_CPV_max, c1c2_max, cos_opening_angle_max;
