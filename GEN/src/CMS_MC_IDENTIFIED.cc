...
namespace Rivet {
  ...
  class CMS_MC_IDENTIFIED : public Analysis {
  public:

    /// Constructor
    CMS_MC_IDENTIFIED()
      : Analysis("CMS_MC_IDENTIFIED")
    {    }
  ...
  public:
    ...
    void init() {
      ...
      book(_histDecayedPIDs ,"MultsDecayedPIDs", 5555, -0.5, 5554.5);
      book(_histAllPIDs     ,"MultsAllPIDs", 5555, -0.5, 5554.5);
  ...
  DECLARE_RIVET_PLUGIN(CMS_MC_IDENTIFIED);
